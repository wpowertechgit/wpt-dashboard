...
const T = {
  ro: {
    ...
    dashboard: {
      ...
      planning: {
        eyebrow: 'Planificare și Lead Time', title: 'Calendar Producție', subtitle: 'Scadențe, finalizări și elemente întârziate',
  ...
  en: {
    ...
    dashboard: {
      ...
      planning: {
        eyebrow: 'Planning and Lead Time', title: 'Production Calendar', subtitle: 'Due dates, completions, and overdue work',
